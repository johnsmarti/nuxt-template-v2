<template>
  <div class="field relative mb-4">
    <div class="input-wrapper relative">
      <Select unstyled :pt="theme" :ptOptions="{
        mergeProps: ptViewMerge
      }" v-model="modelValue" :placeholder="placeholder" :invalid="!!errorMessage" :options="options"
...
const theme = ref<SelectPassThroughOptions>({
  ...
  pcFilter: {
    root: `w-full appearance-none rounded-md outline-hidden
            ...
            ps-3 pe-10 py-3 p-fluid:w-full
  ...
  optionGroup: `m-0 px-3 py-3 bg-transparent text-surface-500 font-semibold`,
  optionGroupLabel: ``,
  option: `cursor-pointer font-normal whitespace-nowrap relative overflow-hidden flex items-center
        px-3 py-3 border-none text-surface-700 bg-transparent rounded-sm

  ...
  <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
    <div class="mx-auto max-w-7xl">
      ...
      <div class="hidden overflow-hidden rounded-lg bg-white shadow-sm lg:block">
          ...
          <table class="w-full">
            <thead>
              <tr class="border-b border-blue-100 bg-blue-50">
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 xl:px-6 xl:py-4 xl:text-sm">
                  Cargo
                </th>
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 xl:px-6 xl:py-4 xl:text-sm">
                  Eleição
            ...
            <tbody>
              ...
              >
                <td class="px-4 py-3 text-xs font-medium text-gray-900 xl:px-6 xl:py-4 xl:text-sm">
                  {{ cargo.name }}
                </td>
                <td class="px-4 py-3 xl:px-6 xl:py-4">
                ...
                <td class="px-4 py-3 text-xs text-gray-900 xl:px-6 xl:py-4 xl:text-sm">
                  {{ cargo.order_index }}
                </td>
                <td class="px-4 py-3 text-xs text-gray-600 xl:px-6 xl:py-4 xl:text-sm">
                  {{ cargo.description }}
                </td>
                <td class="px-4 py-3 xl:px-6 xl:py-4">
        ...
        <!-- Empty State -->
        <div v-if="isLoading || positions.length === 0" class="py-12 text-center">
          <svg
            class="mx-auto mb-4 h-12 w-12 text-gray-300 sm:h-16 sm:w-16"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <p class="text-base text-gray-500 sm:text-lg">Nenhum cargo encontrado</p>
          <p class="mt-2 text-xs text-gray-400 sm:text-sm">Tente ajustar seus filtros de busca</p>
        </div>
      </div>
